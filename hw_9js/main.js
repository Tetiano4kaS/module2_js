...
// let classes = block.classList.add('wrap', 'collapse', 'alpha', 'beta');
// block.style.background='pink';
// block.style.height='200px';
// document.body.appendChild(block);
//
// let clone= block.cloneNode(true)
// clone.style.background='silver';
...
//    c.innerText=`${course.title} - ${course.monthDuration}`;
//   block.appendChild(c)
// }
// document.body.appendChild(block);
...
//
//     let modules = document.createElement("ol")
...
//
//
//     block.append(title,wrapper,modules)
//     document.body.appendChild(block)
//
// }